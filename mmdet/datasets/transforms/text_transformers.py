...
class LoadTextAnnotations(BaseTransform):
    ...
    def get_extra_classes(self, true_classes: tuple, all_classes: tuple) -> tuple:
        ...
        probabilities = {0: 0.1, 1: 0.2, 2: 0.2, 3: 0.2, 4: 0.2, 5: 0.1}
    ...
    def transform(self, results: dict) -> dict:
        ...
        if 'phrases' in results:
            ...
            print("true_classes in text transform", true_classes)
            #text = results['text']
            ...
            combined_classes = list(true_classes + tuple(extra_classes))

            # Randomize the order of combined classes
            #ToDo: check grounding dino model structure and remove if not necessary.
            #random.shuffle(combined_classes)

            # Store the shuffled classes back in results['text']
            results['text'] = tuple(combined_classes)

            print("combined_classes in text transform", combined_classes)
