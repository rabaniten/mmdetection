...
# Epoch 10 eval only: load epoch 10, run 0 training rounds, generate visualizations
LOAD_FROM = "/opt/ml/code/pretrained_models/epoch_10.pth"
...
MAX_EPOCHS = 0  # Eval only - no training, just run test.py for visualizations
