...
ANN_FILE_TRAINING = '/opt/ml/input/data/train/combined_annotations_merged_categories_with_Stefi.json'
ANN_FILE_VALIDATION = '/opt/ml/input/data/validation/coco_annotations_merged_categories_with_Genevieve_and_Stephanie.json'
