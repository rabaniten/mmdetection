# Grounding DINO config for KSW Covers dataset (covers_1338_174)
# Copy to: mmdetection/configs/grounding_dino/config_open_set_covers_1338_174.py
# Usage: Training on SageMaker with s3://genioosfood-data/Covers/KSW/covers_1338_174/
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=COVER_CLASSES),
        pipeline=[
            dict(backend_args=None, type="LoadImageFromFile"),
            dict(type="LoadAnnotations", with_bbox=True),
            dict(classes=COVER_CLASSES, type="LoadTextAnnotations"),
