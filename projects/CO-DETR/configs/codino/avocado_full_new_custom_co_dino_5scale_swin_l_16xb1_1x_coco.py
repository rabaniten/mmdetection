...
test_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='/root/Sofia/Genioos/data/mini_datasets/avocado/avocado.json',
        backend_args=None,
        data_prefix=dict(
            img='/root/Sofia/Genioos/data/mini_datasets/avocado/images/'),
        data_root='/root/Sofia/Genioos/data/mini_datasets/avocado/',
        pipeline=[
